...
INSERT INTO `educations` VALUES (90,NULL,'БГУИР','ПОИТ','студент','2017-06-30','2013-09-01',475);
...
INSERT INTO `resumes` VALUES (475,1,'C/C++/C#/Web programmer.\r\nHas a good operational command of an English language.','','C/C++, C#, Java, Delphi, Assembler i80x86, HTML, PHP','Foreign languages','+375 44 1234567','Nikita Dubko mefody93@gmail.com');
...
INSERT INTO `users` VALUES (1,'EMPLOYEE','scrilan@gmail.com',';�SE�>\'-�|�?#dv�','%{�N��','Egor','Shulga',NULL,NULL,NULL,0),(2,'EMPLOYER','scrilan@gmail.com','�(���Ɔ��;C��f���','*\n�(�','Egor','Shulga',NULL,NULL,NULL,0);
...
INSERT INTO `work_experiences` VALUES (89,'ОИЯИ','ассистент','2015-07-01','2015-09-01',NULL,475);
...
-- Dump completed on 2016-05-02  9:56:57
