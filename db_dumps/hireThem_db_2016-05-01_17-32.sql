...
INSERT INTO `users` VALUES (1,'EMPLOYEE','scrilan@gmail.com',';ï¿½SEï¿½>\'-ï¿½|ï¿½?#dvï¿½','%{ï¿½Nï¿½ï¿½','Egor','Shulga',NULL,NULL,NULL,0),(2,'EMPLOYER','scrilan@gmail.com','ï¿½(ï¿½ï¿½ï¿½Æ†ï¿½ï¿½;Cï¿½ï¿½fï¿½ï¿½ï¿½','*\nï¿½(ï¿½','Egor','Shulga',NULL,NULL,NULL,0),(28,'EMPLOYER','mr@ololo.com','º.4ûnA9§4L\ê\ÓMö\í†V','øØ¬š±º˜w','Mr','Ololo',NULL,NULL,NULL,0);
...
INSERT INTO `vacancies` VALUES (1,28,'Web programmer','Web service, RESTFul, Spring','This Senior Software Engineer will play hands on web services developer role within the PPA team in a Scrum Agile environment. This candidate will be responsible for the creation of quality web service based software components that are used by PPA customers. The Senior Software Engineer will work closely with Tech.Lead and deliver quality, scalable capabilities on time. He/she will be expected to provide guidance and mentoring other developers.','42','Bachelor\'s degree in computer science or related discipline is preferableDeep knowledge and development experience of Web service platforms and middle tier technologies','Java, J2EE, MavenOOPMotivated, self-directed, aptitude for learning and a team playerGit, StashWeb containers(preferably Tomcat)','+375 44 1234567');
...
-- Dump completed on 2016-05-01 17:32:51
