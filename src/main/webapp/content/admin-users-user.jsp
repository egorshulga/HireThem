...
<html lang="en">
  ...
  <s:form name="userAdd" action="submitUserAdmin" method="POST">
    ...
    <section class=" bg-img" style="background-image: url(../assets/img/bg-facts.jpg);">
      ...
      <div class="container">
        ...
        <div class="form-group col-xs-12">
          <input type="text" class="form-control input-lg" placeholder="Surname" name="surname" value="<s:property value="surname"/>">
        </div>
        ...
        <div class="form-group col-xs-12">
          <input type="text" class="form-control input-lg" placeholder="About" name="about" value="<s:property value="about"/>">
        </div>
