...
<header class="site-header size-lg text-center" style="background-image: url(../assets/img/bg-banner1.jpg)">
    <div class="container">
        <div class="col-xs-12">
            ...
            <br><br>
            <h5 class="font-alt">Probably you'll find your answer here. Contact us if you don't find what you're looking
                for.</h5>
        </div>
            ...
            <ul class="faq-items">
                <li>
                    ...
                    <p>Quisque eget laoreet odio. Integer rutrum leo in aliquam iaculis. Integer vestibulum efficitur
                        ...
                        sit amet iaculis nulla orci at dolor. Vivamus dictum erat nisi, id hendrerit dui fringilla
                        elementum. Ut pretium nisi metus, vitae euismod quam tincidunt ut. Maecenas non sem justo.
                        Mauris mollis faucibus elementum. Duis lacinia orci vitae vestibulum consectetur.</p>
                </li>
                ...
                <li>
                    ...
                    <p>Sed sed pulvinar nisl. Etiam a nulla purus. Curabitur maximus mauris eu ante aliquet
                        ...
                        consectetur dictum justo, in scelerisque libero lacinia at. Donec a facilisis sem, a viverra
                        dui. Morbi vestibulum viverra diam, at rutrum nulla porttitor eu.</p>
                </li>
                ...
                <li>
                    ...
                    <p>Pellentesque magna justo, ullamcorper eu efficitur sit amet, porttitor ut velit. Cras sit amet
                        ...
                        nisl. Morbi vitae ullamcorper purus. Integer nec arcu in diam suscipit dapibus. Donec vulputate
                ...
                <li>
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent viverra lacus nec lorem
                        ...
                        magna. Duis at ante elit. Nullam sollicitudin porttitor neque. Integer bibendum, lorem sed
                        porttitor efficitur, mi enim volutpat leo, non sodales sem ligula non sem. Cras ut rutrum
                        nibh.</p>
                </li>
            </ul>
        </div>
            ...
            <ul class="faq-items">
                <li>
                    ...
                    <p>Cras mattis quam ut tortor varius, vel sollicitudin libero congue. Pellentesque ac turpis luctus,
                        ...
                        Praesent malesuada lacus ante, at vestibulum nulla finibus in.</p>
                </li>

                <li>
                    <h5>How do I Find a Good Host for My Website?</h5>
                    <p>Lorem ipsum dolor sit amet test, consectetur adipiscing elit. Pellentesque velit leo, fringilla
                        ac facilisis sit amet, posuere vitae massa. Cum sociis natoque penatibus et magnis dis
                        parturient montes, nascetur ridiculus mus. Donec facilisis finibus nulla vel congue.</p>
                </li>

                <li>
                    <h5>How do I Configure it?</h5>
                    <p>Ut ac justo posuere, maximus dolor vel, lobortis quam. Sed malesuada at magna vitae vestibulum.
                        In hac habitasse platea dictumst. Sed a ultrices massa, in commodo tortor. Quisque faucibus
                        aliquam urna ultrices tristique. Nunc cursus malesuada est eu facilisis. Sed gravida urna eget
                        odio volutpat, ut bibendum dolor condimentum.</p>
                </li>
                ...
                <li>
                    ...
                    <p>Etiam venenatis nisi venenatis, consectetur nibh viverra, efficitur mauris. Ut efficitur, lorem
                        ...
                        malesuada. Donec pretium efficitur malesuada. Quisque vitae gravida sem.</p>
                </li>
            </ul>
        </div>
    </section>
            ...
            <ul class="faq-items">
                <li>
                    ...
                    <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.
                        Donec venenatis vulputate hendrerit. Cras sit amet arcu nulla. Ut tempus laoreet mi, eget semper
                        ligula posuere et. Maecenas pretium diam sed neque placerat, et sagittis justo euismod. Ut
                        consectetur pulvinar odio et blandit. Nullam ut elit malesuada, interdum tortor sed, tincidunt
                        est. Cras ut neque eget mauris rutrum feugiat at in ante. Interdum et malesuada fames ac ante
                        ipsum.</p>
                </li>

                <li>
                    <h5>How do I change the size of the popup comments window?</h5>
                    <p>Aliquam sodales justo a justo fermentum, eu tempor erat rhoncus. Morbi egestas iaculis ante a
                        pharetra. Pellentesque molestie, sem a dictum blandit, justo ante ultrices est, vitae laoreet
                        arcu massa et libero. Phasellus suscipit ipsum sed diam tempus commodo. Curabitur aliquet,
                        lectus sit amet accumsan finibus, est erat imperdiet erat, non varius ex nisl a purus. Mauris ac
                        orci enim. Cras fermentum egestas dolor, id volutpat mi ultricies et. Maecenas tincidunt enim
                        elementum orci placerat, et placerat massa fermentum. Praesent fermentum lectus eget magna
                        iaculis, vitae ultrices mauris porta.</p>
                </li>

                <li>
                    <h5>Where can I find information about styling lists and nested lists?</h5>
                    <p>Etiam congue tortor mauris, vehicula ultrices sem aliquam quis. Maecenas consequat posuere sem,
                        pellentesque suscipit nunc dictum imperdiet. Curabitur ullamcorper, urna at aliquam fringilla,
                        nibh massa tempor purus, id semper ante lectus sit amet metus. Suspendisse tincidunt aliquam
                        feugiat. In scelerisque sodales mollis. Donec dui risus, iaculis ac odio vel, ornare maximus ex.
                        Aenean vitae ipsum eget nisl viverra pharetra eget sed dui.</p>
                </li>

                <li>
                    <h5>How can I get my categories to display in the order I want?</h5>
                    <p>Fusce euismod purus tempor enim lacinia, at commodo dui fermentum. Sed eu nulla eget enim laoreet
                        cursus. Pellentesque blandit posuere magna vel dignissim. Nulla justo neque, lobortis vel
                        consectetur at.</p>
                </li>
            </ul>
        </div>
            ...
            <ul class="faq-items">
                <li>
                    ...
                    <p>Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas.
                        Donec venenatis vulputate hendrerit. Cras sit amet arcu nulla. Ut tempus laoreet mi, eget semper
                        ligula posuere et. Maecenas pretium diam sed neque placerat, et sagittis justo euismod. Ut
                        consectetur pulvinar odio et blandit.</p>
                </li>
                ...
                <li>
                    ...
                    <p>Aenean non lorem at elit cursus efficitur at aliquet est. Quisque varius enim ante, in vestibulum
                        dui efficitur in. Nullam sit amet elit sed tortor posuere finibus a in odio. Duis ac dui
                        finibus, mollis massa sit amet, lacinia magna. Sed non tortor sit amet nisi fringilla pretium
                        non at mi. Aenean lobortis sapien at condimentum tempor. Curabitur vitae purus maximus ligula
                        volutpat feugiat. In hac habitasse platea dictumst. Etiam sit amet metus at urna dignissim
                        lacinia.</p>
                </li>
            </ul>
        </div>
