...
S[38] = '                <ul>                                                                              ';
S[39] = '                    <li><a>Browse resumes</a></li>                                                ';
S[40] = '                    <li><a href="employee_profile.jsp">Resume detail</a></li>                     ';
S[41] = '                    <li><a href="resume.jsp">Create a resume</a></li>                             ';
S[42] = '                    <li><a>Manage resumes</a></li>                              ';
S[43] = '                </ul>                                                                             ';
S[44] = '            </li>                                                                                 ';
S[45] = '            <li>                                                                                  ';
S[46] = '                <a href="#">Vacancy</a>                                                           ';
S[47] = '                <ul>                                                                              ';
S[48] = '                    <li><a>Browse vacancies</a></li>      <li><a href="vacancy.jsp">Create a vacancy</a></li>                                           ';
S[49] = '                    <li><a href="vacancy.jsp">Manage vacancies</a></li>                           ';
S[50] = '                </ul>                                                                             ';
S[51] = '            </li>                                                                                 ';
S[52] = '            <li>                                                                                  ';
S[53] = '                <a href="#">Pages</a>                                                             ';
